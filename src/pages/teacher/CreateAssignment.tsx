          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="label-style flex items-center gap-2">
                ...
                <span className="text-xs bg-gold-400/20 text-gold-600 px-2 py-0.5 rounded font-mono">Opcional</span>
              </label>
              <textarea value={form.nem_process} onChange={e => setForm(f => ({ ...f, nem_process: e.target.value }))} rows={3} placeholder="Describe la secuencia didáctica o proceso de la Nueva Escuela Mexicana…" className="input-style w-full resize-none" />
            </div>
          </div>
        </div>
